            ...
            >
                ...
                <ul class="flex gap-4 sm:gap-8">
                    ...
                    <a
                        :href="`mailto:${mail}`"
                        target="__blank"
                        class="rounded-full h-11 w-11 sm:h-12 sm:w-12 inline-flex items-center justify-center mx-2 bg-white dark:bg-dark shadow-lg border-dark dark:border-secondary border-2 hover:bg-dark text-dark dark:text-white dark:hover:bg-secondary dark:hover:text-primary hover:text-white text-center"
                    >
