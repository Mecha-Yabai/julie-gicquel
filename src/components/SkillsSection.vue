    ...
    <div class="flex flex-col h-full justify-center">
      <div class="flex flex-col lg:flex-row">
        <div class="w-full lg:w-6/12 text-left lg:pr-8">
          ...
          >
            Un <span class="text-red-500">profil</span>,<br />
            Triple <span class="text-red-500">compétences</span>.
          </h1>
          <div class="h-2/3 lg:h-fit space-y-4 lg:space-y-8">
            ...
            <div>
              <p
                class="text-center md:text-left font-jiho-regular text-md md:text-lg xl:text-xl leading-none text-gray-500"
              >
                Après quelques expériences, j’ai décidé de me ré-orienter dans
                le développement web pour apprendre la technique nécessaire pour
                me permettre de concevoir de manière plus concrète mes idées.
              </p>
            </div>
            <div>
              <p
          ...
          <div class="space-y-4 sm:space-y-10">
            <div class="mt-6 sm:mt-0">
              ...
              <div class="flex items-top sm:mb-10">
                <p
                  class="mr-4 text-xl sm:text-3xl text-red-500 font-jiho-regular"
                >
                  01 /
                </p>
                <h1
                  class="text-left text-xl md:text-3xl lg:text-4xl font-jiho-medium text-primary-dark dark:text-primary-light"
                >
                  Développement<br />
                  Full-Stack
                </h1>
