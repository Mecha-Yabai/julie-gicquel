<template>
    <section class="h-full min-h-screen flex content-center py-4">
        <div class="flex flex-col justify-around lg:justify-between">
            ...
            >
                <div class="w-full lg:w-6/12 text-left lg:pr-8">
                    ...
                    <div class="mb-4 sm:mb-6 lg:mt-10">
                        ...
                        <p
                            class="mt-2 text-justify sm:text-center lg:text-justify font-jiho-regular text-lg lg:text-xl leading-none text-gray-500 dark:text-ternary-light"
                        >
                            {{ $t("hero_2") }}
                        </p>
                    </div>
            ...
            <div
                class="flex lg:flex-none items-center justify-center py-4 sm:py-2"
            >
                <a href="#skills">
                    <button
